...
public class SubDAO extends BaseHibernateDAO {
	...
	public List findByExample(Sub instance) {
		...
		try {
			List results = getSession().createCriteria("orm.Sub").add(Example.create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Sub instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Sub as model where model." + propertyName + "= ?";
